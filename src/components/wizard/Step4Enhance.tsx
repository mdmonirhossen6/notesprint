  ...
  return (
    <div className="flex flex-col h-full animate-in fade-in slide-in-from-right-4 duration-300">
      <div className="text-center mb-6">
        <h2 className="text-2xl font-bold mb-2">Enhance Document</h2>
        <p className="text-muted-foreground text-sm">Apply AI-inspired filters to clean up your notes</p>
      </div>
      ...
      <div className="flex items-center justify-between border-t border-card-border pt-6 mt-auto">
        ...
        <GradientButton onClick={() => setStep(5)}>
          Continue to Layout
        </GradientButton>
      </div>
    </div>
